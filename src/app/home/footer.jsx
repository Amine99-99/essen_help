         ...
         <div className='w-[20vw]'>
          ...
          />
                  ...
                  <div className='w-[60vw] '>
                        ...
                        <div className=' flex flex-col gap-1 text-[16px] justify-start p-5 items-start  xl:grid  grid-cols-3 flex justify-start items-start  font-bold text-gray-800 text-[20px]'>
